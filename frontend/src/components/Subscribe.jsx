        ...
        <Container bgColor={"#fff"}>
            <div className="flex flex-col-reverse md:flex-row items-center justify-center py-10 sm:py-20">
                <div className="w-[85%] md:w-[70%]">
                    <div className="bg-white shadow-xl border relative mt-[-80px] md:static md:mt-0 md:mx-0 rounded-xl overflow-hidden p-8 sm:p-14 lg:pr-40 scale-from-back-sum-text">
                        ...
                        <p className="text-gray-600 mb-10 text-center md:text-start">
                            Get news first. Stay in touch with our latest
                            updates, investor news and media releases
                        </p>
                ...
                <img
                    ...
                    className="md:relative md:px-0 md:mt-0 md:ml-[-120px] md:hidden lg:block md:max-w-[500px] h-96 scale-from-right-sum-img"
                />
            </div>
        </Container>
    );
