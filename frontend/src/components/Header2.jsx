...
function Header2({ bg }) {
    ...
    const service = [
        ...
        },
        {
            key: "2",
            label: (
                <Link to="/service/freight-transportation">
            ...
            <nav className=" shadow-md block mx-auto  w-full md:static md:shadow-none z-20">
                <div className="lg:container mx-auto md:flex justify-end items-center hidden h-[50px] border-b">
                    {isAdmin && (
                        <Link
                            to="/admin/dashboard"
                            className="text-slate-800 mr-10"
                        >
                            Admin panel
                        </Link>
                    )}
                    ...
                    {currentUser ? (
                        <Popconfirm
                            ...
                            cancelText="Үгүй"
                        >
                            <p className="text-slate-800 mr-10 cursor-pointer">
                                Logout
                            </p>
                        </Popconfirm>
                    ) : (
                ...
                <Affix offsetTop={0}>
                    <div className="bg-white ">
                        <div className="lg:container mx-auto px-4 flex justify-between items-center md:h-[100px] h-[60px]">
                            ...
                            <ul
                                className={`bg-white z-50 duration-300 ease-out md:h-auto overflow-hidden top-[60px] md:bg-transparent text-center md:flex justify-between items-center fixed md:static left-0 ${
                                    open
