                    ...
                    <div className=" md:min-h-[400px] flex md:flex-row flex-col shadow-lg rounded-xl overflow-hidden">
                        <div className="flex-[1]">
                            <img
                                ...
                                className="h-full object-cover w-full scale-from-left"
                            />
                        </div>
                        <div className="flex-[1] bg-white lg:p-20 p-10 flex flex-col justify-between">
                            <div>
                                <p className="text-4xl font-semibold mb-5 scale-from-right">
                                    Greeting
                                </p>
                                <div className="mb-5">
                                    <i className="fa-solid fa-quote-left text-[#FE7200] scale-from-right"></i>
                                    <p className="px-1 scale-from-right">
                                        Mineral products account for more than
                                        90% of Mongolia's exports, and in the
                                        first seven months of last year, this
                                        sector alone accounted for 32.5% of
                                        Mongolia's total revenue budget.
                                        According to the statistics of the road
                                        transport industry, in the first quarter
                                        of 2021, 53.4 percent of the total 17.4
                                        million tons of cargo was transported by
                                        road and 46.6 percent by rail.
                                    </p>
                                    <div className="flex justify-end scale-from-right">
                                        <i className="fa-solid fa-quote-right text-[#FE7200]"></i>
                                    </div>
                                </div>
                            </div>
                            <div className="rounded-xl border-2 p-5 scale-from-bottom">
                            ...
                            <div>
                                <div className="mb-6">
                                    ...
                                    <p className="font-semibold text-lg px-1">
                                        Railway is a sector that attracts and
                                        elevates the country's strategic
                                        development.
                                    </p>
